	...
	<div class="popup-background blind">
		...
		<div id="login-section" class="blind">
			...
			<section class="login-popup-input-section">
				<input type="text" id="login-id" class="login-popup-input"
					placeholder="아이디를 입력하세요." /> <input type="password" id="login-pw"
					class="login-popup-input" placeholder="비밀번호를 입력하세요." />
			</section>
			...
			<section class="join-popup-input-section">
				<div class="input-wrap">
					<div class="input-check">
						<input type="email" id="join-email" class="join-popup-input-short"
							placeholder="이메일" /> <input type="button" id="check_email"
							class="join-popup-check-btn" value="인증하기" />
					</div>
					<span class="warning-text blind">다시 시도해주세요.</span>
				</div>
				<div class="input-wrap">
					<div class="input-check">
						<input type="text" id="join-email-code"
							class="join-popup-input-short" placeholder="인증번호" /> <input
							type="button" id="check_email-code" class="join-popup-check-btn"
							value="확인" />
					</div>
					<span class="warning-text blind">다시 시도해주세요.</span>
				</div>
				<div class="input-wrap">
					<div class="input-check">
						<input type="text" id="join-id" class="join-popup-input-short"
							placeholder="아이디" /> <input type="button" id="check_id"
							class="join-popup-check-btn" value="중복확인" />
					</div>
					<span class="warning-text">이미 아이디가 존재합니다.</span>
				</div>
				<input type="password" id="join-pw" class="join-popup-input"
					placeholder="비밀번호" /> <input type="password" id="join-re-pw"
					class="join-popup-input" placeholder="비밀번호 재입력" /> <input
					type="text" id="join-name" class="join-popup-input"
					placeholder="이름" /> <input type="text" id="join-tel"
					class="join-popup-input" placeholder="전화번호(-없이 입력)" /> <input
					type="text" id="join-birth" class="join-popup-input"
					placeholder="생년월일(숫자로만 입력)" />
			</section>
