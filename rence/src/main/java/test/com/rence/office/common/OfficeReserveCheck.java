...
import test.com.rence.office.model.OfficeReserveVO_date;
import test.com.rence.office.model.OfficeRoomVO;

public class OfficeReserveCheck {
	

	@Autowired
	SqlSession sqlSession;

	private static final Logger logger = LoggerFactory.getLogger(OfficeReserveCheck.class);
	
	public OfficeReserveCheck() {
		logger.info("OfficeReserveCheck()...");
	}

	public int ReserveCheck(OfficeReserveVO vo) throws ParseException {

		int flag = 0;

		logger.info("reserveCheck :: {}", vo);
