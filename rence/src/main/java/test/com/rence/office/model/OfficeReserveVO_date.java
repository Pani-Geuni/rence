...
public class OfficeReserveVO_date implements Serializable {
	...
	public OfficeReserveVO_date() {
		// TODO Auto-generated constructor stub
	}

	public OfficeReserveVO_date(String reserve_no, Date reserve_stime, Date reserve_etime, Date reserve_sdate,
			Date reserve_edate, String reserve_state, String room_no, String user_no, String backoffice_no,
			String room_type) {
		super();
	...
	public String toString() {
		return "OfficeReserveVO_date [reserve_no=" + reserve_no + ", reserve_stime=" + reserve_stime
				+ ", reserve_etime=" + reserve_etime + ", reserve_sdate=" + reserve_sdate + ", reserve_edate="
				+ reserve_edate + ", reserve_state=" + reserve_state + ", room_no=" + room_no + ", user_no=" + user_no
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OfficeReserveVO_date other = (OfficeReserveVO_date) obj;
